...
public class oEnemyBullet9 : MonoBehaviour {//ミクストバレット
    Quaternion f;
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            //他の弾とぶつかったら拡大
            transform.localScale = new Vector3(transform.localScale.x + 0.4f, transform.localScale.y + 0.02f, transform.localScale.z);
        }
